...
# The cluster zone is created by openshift-install. We look it up here
# so terraform can output the zone ID for scripts/configure-manifests.sh
# and the cert-manager ClusterIssuer hostedZoneID.
