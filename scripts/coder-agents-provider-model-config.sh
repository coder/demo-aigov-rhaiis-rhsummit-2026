...
: "${RHAIIS_MODEL_ID:=RedHatAI/Llama-3.3-70B-Instruct-quantized.w4a16}"
: "${RHAIIS_DISPLAY_NAME:=Llama 3.3 70B Instruct INT4 (RHAIIS sovereign)}"
: "${RHAIIS_PROVIDER_DISPLAY:=RHAIIS (Sovereign Llama 3.3 70B)}"
